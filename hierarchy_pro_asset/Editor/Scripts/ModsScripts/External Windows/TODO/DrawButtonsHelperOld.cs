...
namespace EMX.HierarchyPlugin.Editor.Mods
{
	...
	internal partial class DrawButtonsOld
	{
		...
		static ISET_ROW EXT_BOOKMARKS_KEY = new ISET_ROW( Mods.BookObject.BookmarksforGameObjectsModWindow.NAME , "EXT_" + B_K, 2, 10, MemType.Custom, 0, 20, true) // 10 22 //// 6 44
