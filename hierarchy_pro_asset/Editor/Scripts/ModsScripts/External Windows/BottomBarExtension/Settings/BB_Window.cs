...
namespace EMX.HierarchyPlugin.Editor.Settings
{
	...
	class SETGUI_BottomBar : MainRoot
	{
		...
		static void dr_l( int i, int __index )
		{
			...
			r2.width = r2.x + r2.width - start;
			r2.x = start;
			r2.width /= 4;


			var p = RowsClasses[ i ];
			Draw.FIELD_R( r2, "Font size", p._fontSize_KEY, 4, 30, overrideObject: p, lablelOffset: OBJECT_WIDTH[ 5 ] + 20 );
			r2.x += r2.width;
			Draw.FIELD_R( r2, "Height", p._RowHeight_KEY, 1, 90, overrideObject: p, lablelOffset: OBJECT_WIDTH[ 5 ] + 20 );
			r2.x += r2.width;
			Draw.FIELD_R( r2, "Rows", p._Rows_KEY, 1, 10, overrideObject: p, lablelOffset: OBJECT_WIDTH[ 5 ] + 20 );

			r2.x += r2.width;
			Draw.FIELD_R( r2, "Buttons", p._MaxItems_KEY, 1, 30, overrideObject: p, lablelOffset: OBJECT_WIDTH[ 5 ] + 20 );
